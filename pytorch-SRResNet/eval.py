...
name=['baby-GT','bird-GT','butterfly-GT','head-GT','woman-GT']
...
for image_name in image_list:
    ...
    im_h = Image.fromarray(im_h_ycbcr, "YCbCr").convert("RGB")
    im_h.save("./result/"+ name[num] +"_SRreNet.png")
    print("--"*15)
    num += 1

print("Scale=", opt.scale)
print("Dataset=", opt.dataset)
print("avg_PSNR_predicted=", avg_psnr_predicted/len(image_list))
print("avg_PSNR_bicubic=", avg_psnr_bicubic/len(image_list))
