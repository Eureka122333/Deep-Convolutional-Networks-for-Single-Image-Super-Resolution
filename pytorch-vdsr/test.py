...
images= os.listdir(filePath+'/Set5/GT/')
...
for image in images:
    ...
    name = suffixs.pop()
    print(name)
    im_gt_ycbcr = imread("./Set5/GT/"+ name + ".bmp", pilmode="YCbCr")
    im_b_ycbcr = imread("./Set5/x4/"+ name + "_scale_"+ str(opt.scale) + ".bmp", pilmode="YCbCr")
    ...
    im_h.save("./result/"+name+"_vdsr.png")
